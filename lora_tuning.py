...
if __name__ == '__main__':
    ...
    parser.add_argument('epochs', type=int, help='Input the number of epochs to train the model')
    parser.add_argument('lr', type=float, help='Input the learning rate')
    parser.add_argument('batch_size', type=int, help='Input the batch size')
    parser.add_argument('lora_r', type=int, help='Input the rank to use for LoRA')
    parser.add_argument('lora_alpha', type=float, help='Input the alpha to use for LoRA')
    parser.add_argument('lora_dropout', type=float, help='Input the dropout rate to use for LoRA')
